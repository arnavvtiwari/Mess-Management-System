            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-slate-900 uppercase">Follow me</h2>
                            <ul className="text-slate-500 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/arnavvtiwari"
                                ...
                                <li>
                                <a
                                        href="https://www.linkedin.com/in/arnav-tiwari-23b23b233/"
                                        className="hover:underline"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
